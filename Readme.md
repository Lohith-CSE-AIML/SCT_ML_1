...
| Resource | Link |
| -------- | ---- |
| 🌐 **Live Demo** | [Open Streamlit Application](YOUR_ACTUAL_STREAMLIT_URL_HERE) |
| 💻 **GitHub Repository** | [View Source Code](https://github.com/Lohith-CSE-AIML/SCT_ML_1) |
